...
async def update_attendance(
    body: UpdateAttendanceRequest, db: DBDep, user_id: CurrentUserIdDep,
    _role: str = require_role(Role.TUTOR, Role.ADMIN),
):
...
async def update_ct_score(
    body: UpdateCtScoreRequest, db: DBDep, user_id: CurrentUserIdDep,
    _role: str = require_role(Role.TUTOR, Role.ADMIN),
):
...
async def update_lab_score(
    body: UpdateLabScoreRequest, db: DBDep, user_id: CurrentUserIdDep,
    _role: str = require_role(Role.TUTOR, Role.ADMIN),
):
